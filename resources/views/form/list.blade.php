                                            ...
                                            <section>
                                              <div class="form-group row justify-content-md-end" >
                                                <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4" > 
                                                  <a href="form" > <button class="btn waves-effect waves-light btn-primary btn-outline-primary btn-lg btn-block" ><i class="fa fa-plus-circle"></i>เพิ่มข้อมูลการตรวจสอบฝาย</button></a>
                                                </div>
                                                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2" > 
                                                  <button class="btn waves-effect waves-light btn-primary btn-outline-primary btn-lg btn-block"><i class="fa fa-home"></i>หน้าแรก</button>
                                                </div>
                                              </div>
                                              <div class="card">
                                                <div class="card-block">
                                                  <div class="row">
                                                    <div class="col-lg-12 col-xl-12">
                                                      <?php if($user!="ddpmcr (ปภ.จ.ชร.)"){ ?>
                                                        <div class="sub-title">รายละเอียดการตรวจสอบฝาย โดย {{$user}}</div>
                                                      <?php }else{ ?> 
                                                        <div class="sub-title">รายละเอียดการตรวจสอบฝายสำหรับผู้ดูแลระบบ: {{$user}}</div>
                                                      <?php } ?>
                                                                        ...
                                                                        <tbody>
                                                                          <?php for($i = 0;$i < count($dataUser);$i++){  ?>
                                                                            <tr>
                                                                              ...
                                                                              <td>{{$dataUser[$i]['user']}}</td>
                                                                              
                                                                              <td align="center"> 
                                                                                <a href='{{ asset('/pdf') }}/{{$dataUser[$i]['weir_code']}}' target=_blank ><button class="btn waves-effect waves-dark btn-mini btn-info btn-outline-info" title="view"><i class="icofont icofont-eye-alt"></i></button></a>
                                                                                <a href='{{ asset('/edit') }}/{{$dataUser[$i]['weir_code']}}' target=_blank><button class="btn waves-effect waves-dark btn-mini btn-warning btn-outline-warning" title="edit"><i class="icofont icofont-edit-alt"></i></button> </a>
                                                                                <a href='{{ asset('/addphoto') }}/{{$dataUser[$i]['weir_code']}}' target=_blank><button class="btn waves-effect waves-dark btn-mini btn-inverse btn-outline-inverse" title="add image"><i class="fa fa-file-image-o"></i></button> </a>
