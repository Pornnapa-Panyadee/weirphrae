    ...
    <body>
        <div class="row" align="center" style="page-break-after:always; margin-top:60px;"> 
            <table align="center" class="customers" width="80%">
                ...
                <tr>
                    <td colspan="4" height=200px; class="customers"> <font style="font-size:42px;"><b><?php echo($text_amp); ?>  จังหวัดแพร่</b></td>
                </tr>
                <tr>
                    <td colspan="4" height=200px; class="customers"> <font style="font-size:32px;"><b>โครงการพัฒนาระบบการสำรวจและฐานข้อมูลเพื่อบริหารจัดการพื้นที่เสี่ยงภัยน้ำท่วมและภัยแล้ง 
                    <br>ระดับจังหวัดในพื้นที่ภาคเหนือตอนบน (ระยะที่ 1)<b></td>
                </tr>
                <tr>
                    <td colspan="4" height=100px;> <font style="font-size:26px;"><b>โดย สถาบันสารสนเทศทรัพยากรน้ำ (องค์การมหาชน)  <br> มหาวิทยาลัยเชียงใหม่ <b></td>
                </tr>
            </table>
