    ...
    return function r(e, t, n) {
        ...
        1: [function (r, e, t) {
            ...
            function u(r, e, t) {
                function n(r, t) {
                    ...
                    return r ? o.fire("error", {
                        error: r
                    }) : (o.on("error", n), p(t.responseText, e, o), o.off("error", n), void (i || o.fire("ready")))
                }
                var o = t || L.geoJson();
                return y(r, n), o
            }
            ...
            function a(r, e, t) {
                function n(r, t) {
                    ...
                    return r ? o.fire("error", {
                        error: r
                    }) : (o.on("error", n), h(t.responseXML || t.responseText, e, o), o.off("error", n), void (i || o.fire("ready")))
                }
                var o = t || L.geoJson();
                return y(r, n), o
            }
            ...
            function s(r, e, t) {
                function n(r, t) {
                    ...
                    return r ? o.fire("error", {
                        error: r
                    }) : (o.on("error", n), g(t.responseXML || t.responseText, e, o), o.off("error", n), void (i || o.fire("ready")))
                }
                var o = t || L.geoJson();
                return y(r, n), o
            }
        ...
        4: [function (r, e, t) {
            function n(r, e, t) {
                ...
                }, a.onprogress = function () { }, a.ontimeout = function (r) {
        ...
        5: [function (r, e, t) {
            ...
            function p(r, e, t) {
                ...
                var l = "string" == typeof r ? d.dsvFormat(e.delimiter).parse(r) : r;
                if (!l.length) return void t(null, c);
                var p, h = [];
                n || (n = o(l[0])), u || (u = i(l[0]));
                var g = !n || !u;
                if (g) {
                    for (p = 0; p < l.length; p++) s.push({
                        type: "Feature",
                        properties: l[p],
                        geometry: null
                    });
        ...
        6: [function (e, t, n) {
            ! function (e, o) {
                ...
                function o(r) {
                            ...
                            if (34 === r.charCodeAt(t)) {
                                for (var n = t; n++ < s;)
                                    if (34 === r.charCodeAt(n)) {
                                        ...
                                        ++n
                                    } return f = n + 2, e = r.charCodeAt(n + 1), 13 === e ? (o = !0, 10 === r.charCodeAt(n + 2) && ++f) : 10 === e && (o = !0), r.slice(t + 1, n).replace(/""/g, '"')
                            }
                            for (; f < s;) {
                                var a = 1;
                                if (e = r.charCodeAt(f++), 10 === e) o = !0;
                                else if (13 === e) o = !0, 10 === r.charCodeAt(f) && (++f, ++a);
                                else if (e !== l) continue;
                                return r.slice(t, f - a)
                            }
                            return r.slice(t)
                        }
                        for (var n, o, i = {}, u = {}, a = [], s = r.length, f = 0, c = 0;
                            (n = t()) !== u;) {
                    ...
                    function u(e, t) {
                        return null == t && (t = n(e)), [t.map(f).join(r)].concat(e.map(function (e) {
                ...
                var i = o(","),
                    ...
                    h = c.format,
                    g = c.formatRows;
                r.dsvFormat = o, r.csvParse = u, r.csvParseRows = a, r.csvFormat = s, r.csvFormatRows = f, r.tsvParse = l, r.tsvParseRows = p, r.tsvFormat = h, r.tsvFormatRows = g, Object.defineProperty(r, "__esModule", {
                    value: !0
                })
            })
        }, {}],
        7: [function (r, e, t) {
            ...
            function a(r, e, t) {
                if (e || (e = "NSEW"), "string" != typeof r) return {
                    val: null,
                    regex: t
                };
        ...
        8: [function (r, e, t) {
            ...
            function o(r) {
                for (var e = [], t = 0; t < r.length; t++) e.push(r[t].slice().reverse());
                return e
            }
            var i = {};
        ...
        9: [function (r, e, t) {
            (function (n) {
                var o = function () {
                    ...
                    function h(r) {
                        for (var e = r.replace(x, "").split(w), t = [], n = 0; n < e.length; n++) t.push(p(e[n]));
                        return t
                    }

                    function g(r) {
                        var e, t = [u(r, "lon"), u(r, "lat")],
                            n = a(r, "ele"),
                    ...
                    var L = {
                        kml: function (r) {
                            ...
                            for (var g = d(), m = {}, y = ["Polygon", "LineString", "Point", "Track", "gx:Track"], x = o(r, "Placemark"), w = o(r, "Style"), L = o(r, "StyleMap"), E = 0; E < w.length; E++) m["#" + i(w[E], "id")] = e(v(w[E])).toString(16);
                            for (var S = 0; S < L.length; S++) m["#" + i(L[S], "id")] = e(v(L[S])).toString(16);
                        ...
                        gpx: function (r) {
                            ...
                            function u(r) {
                                var e, t = ["name", "desc", "author", "copyright", "link", "time", "keywords"],
                                    n = {};
            ...
            ! function (e, o) {
                ...
                function f(r, e) {
                    ...
                    return e.forEach(function (t, n) {
                        ...
                        if (e = u[a])
                            ...
                            if (delete i[e.start], e.unshift(r), e.start = a, n = u[a]) {
                                delete u[n.end];
                ...
                function l(r, e, t) {
                    ...
                    if (arguments.length > 1) {
                        ...
                        for (var p = 0, h = r.arcs.length; p < h; ++p) a.push(p);
                    return {
                ...
                function d(r, e) {
                    ...
                    return e.forEach(function (r) {
                        ...
                        arcs: u.map(function (e) {
                            ...
                            }), i = f(r, i), (t = i.length) > 1)
                                for (var u, a, s = 1, c = n(i[0]); s < t; ++s)(u = n(i[s])) > c && (a = i[0], i[0] = i[s], i[s] = a, c = u);
                            return i
                        })
                    }
                }
            ...
            function n(r) {
                ...
                function o() {
                    ...
                    for (var r, t = 0, o = [], i = [o], a = o; r = e(/^(\()/) || e(/^(\))/) || e(/^(\,)/) || e(u);) {
                        if ("(" === r) i.push(a), a = [], i[i.length - 1].push(a), t++;
                        else if (")" === r) {
                ...
                function i() {
                    for (var r, t, o = []; t = e(u) || e(/^(\,)/);) "," === t ? (o.push(r), r = []) : t.split(/\s/g).some(isNaN) || (r || (r = []), Array.prototype.push.apply(r, t.split(/\s/g).map(parseFloat))), n();
                ...
                function s() {
                    ...
                    n();
                    var r = v.substring(v.indexOf("(") + 1, v.length - 1).replace(/\(/g, "").replace(/\)/g, "");
                    v = "MULTIPOINT (" + r + ")";
                    var t = o();
                    return t ? (n(), {
                        type: "MultiPoint",
            ...
            function o(r) {
                ...
                switch ("Feature" === r.type && (r = r.geometry), r.type) {
                    ...
                    case "GeometryCollection":
                        return "GEOMETRYCOLLECTION (" + r.geometries.map(o).join(", ") + ")";
                    default:
